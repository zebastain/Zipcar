...
<body>
    ...
    <div class="d-flex flex-column bd-highlight mt-5 ml-5" style="position: absolute;">
        <div class="p-2 bd-highlight text-white mt-5 pt-5" style="font-size: 30px; font-weight: 700;">Access to cars
            near you, 24/7</div>
        <div class="p-2 bd-highlight text-white">The freedom of cars on demand in hundreds of cities, <br>ready to book
            by the hour or day.</div>
        <a class="nav-link text-light bg-warning rounded-pill text-center mt-4 join-button shadowed "
            style="width: 60%; font-weight: 700;" href="#"><i class="far fa-play-circle"></i> Watch how it works</a>
    </div>
    <img src="{{ asset('img/back3.png') }}" class="selectDisable" style="max-height: 100%; max-width: 100%; z-index: -1;">
    ...
    <div class="container marketing mt-5">
        ...
        <div class="row">
            <div class="col-lg-4">
                <img src="{{ asset('img/icons8-car-100.png') }}" alt="Generic placeholder image" width="140" height="140">
                <h2>Catalog</h2>
                <p>We offer you an extense car catalog, so you can choose the one that suits your necessities the most.
                </p>
                <p><a class="btn bg-warning shadowed mt-4" href="#" role="button">View details &raquo;</a></p>
            </div>
            <div class="col-lg-4">
                <img src="{{ asset('img/icons8-gps-100.png') }}" alt="Generic placeholder image" width="140" height="140">
                <h2>GPS Tracking</h2>
                <p>Here in Zipcar we think about your safety, and all our cars are equipped with a GPS Tracking and an
                    Anti-theft system.</p>
                <p><a class="btn bg-warning shadowed mt-4" href="#" role="button">View details &raquo;</a></p>
            </div>
            <div class="col-lg-4">
                <img src="{{ asset('img/icons8-uber-500.png') }}" alt="Generic placeholder image" width="140" height="140">
                <h2>Uber</h2>
                <p>Thanks to our partnership with Uber you can also contract a driver to drive your car, with discounts
                    up to 70%.</p>
                <p><a class="btn bg-warning shadowed mt-4" href="#" role="button">View details &raquo;</a></p>
            </div>
        </div>
    ...
    <h2 class="text-right mr-5" style="font-size: 20px;">Zipcars come in all shapes and sizes—compact sedans, luxury
        SUVs</h2>
    <div class="container">
        ...
        <div id="demo" class="carousel slide" data-ride="carousel">
            ...
            <div class="carousel-inner no-padding my-5">
                <div class="carousel-item active">
                    <div class="col-xs-4 col-sm-4 col-md-4">
                        <a href="#" onclick=abc(this) class="slider_info">
                            <img class="img-fluid card-img-top" src=" {{ asset('img/car3.png') }}">
                        </a>
                        <p class="text-center"
                            style="font-family:'Franklin Gothic Medium', 'Arial Narrow', Arial, sans-serif">car</p>

                    </div>
                    <div class="col-xs-4 col-sm-4 col-md-4">
                        <a href="#" onclick=abc(this) class="slider_info">
                            <img class="img-fluid card-img-top rounded-bottom" src=" {{ asset('img/car2.png') }}">
                        </a>
                        <p class="text-center"
                            style="font-family:'Franklin Gothic Medium', 'Arial Narrow', Arial, sans-serif">car</p>
                    ...
                    <div class="col-xs-4 col-sm-4 col-md-4">
                        <a href="#" onclick=abc(this) class="slider_info">
                            <img class="img-fluid card-img-top rounded-bottom" src="{{ asset('img/car1.png') }}">
                        </a>
                        <p class="text-center"
                            style="font-family:'Franklin Gothic Medium', 'Arial Narrow', Arial, sans-serif">car</p>
                ...
                <div class="carousel-item">
                    <div class="col-xs-4 col-sm-4 col-md-4">
                        <a href="#" onclick=abc(this) class="slider_info">
                            <img class="img-fluid card-img-top" src="{{ asset('img/car4.png') }}">
                        </a>
                        <p class="text-center"
                            style="font-family:'Franklin Gothic Medium', 'Arial Narrow', Arial, sans-serif">car 4</p>
                    </div>
                    <div class="col-xs-4 col-sm-4 col-md-4">
                        <a href="#" onclick=abc(this) class="slider_info">
                            <img class="img-fluid card-img-top" src="{{ asset('img/car3.png') }}">
                    ...
                    <div class="col-xs-4 col-sm-4 col-md-4">
                        <a href="#" onclick=abc(this) class="slider_info">
                            <img class="img-fluid card-img-top" src="{{ asset('img/car2.png') }}">
                        </a>
                        <p class="text-center"
                            style="font-family:'Franklin Gothic Medium', 'Arial Narrow', Arial, sans-serif">car</p>
                    </div>
        ...
        <a class="shadowed nav-link bg-warning rounded-pill text-center mt-4 mb-5 join-button shadowed"
          style="width: 20%; margin: 0 auto; color:black;" href="{{route('register')}}">Join now</a>
    </div>
    <footer class="page-footer font-small green pt-4">
        ...
        <!-- Copyright -->
        <div class="footer-copyright text-white text-center py-3" style="background: rgb(7, 148, 199);">© 2020
            Copyright:
